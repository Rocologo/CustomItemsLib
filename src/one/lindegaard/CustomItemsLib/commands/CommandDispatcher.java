...
public class CommandDispatcher implements CommandExecutor, TabCompleter {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (!com.canBeConsole()
			...
			Core.getMessages().senderSendMessage(sender, ChatColor.RED + Core.getMessages().getString("core.commands.base.noconsole", "command", "/" + label + " " + subCommand));
			return true;
		}
		if (!com.canBeCommandBlock() && sender instanceof BlockCommandSender) {
			Core.getMessages().senderSendMessage(sender, ChatColor.RED + Core.getMessages().getString("core.commands.base.nocommandblock", "command", "/" + label + " " + subCommand));
			return true;
		}
		...
		if (!com.onCommand(sender, subCommand, subArgs)) {
			...
			usageString = ChatColor.RED + Core.getMessages().getString("core.commands.base.usage", "usage", usageString);
			Core.getMessages().senderSendMessage(sender, usageString);
		}
	...
	private void displayUsage(CommandSender sender, String label, String subcommand) {
		...
		if (subcommand != null) {
			Core.getMessages().senderSendMessage(sender,
					ChatColor.RED + Core.getMessages().getString("core.commands.base.unknowncommand", "command",
							ChatColor.RESET + "/" + label + " " + ChatColor.GOLD + subcommand));
			Core.getMessages().senderSendMessage(sender,
					Core.getMessages().getString("core.commands.base.validcommands"));
		} else {
			Core.getMessages().senderSendMessage(sender,
					ChatColor.RED + Core.getMessages().getString("core.commands.base.nocommand", "command",
		...
		Core.getMessages().senderSendMessage(sender, usage);

		if (subcommand == null) {
			Core.getMessages().senderSendMessage(sender, Core.getMessages().getString("core.commands.base.morehelp"));
		}
	...
	private class InternalHelp implements ICommand {
		...
		public String getDescription() {
			return Core.getMessages().getString("core.commands.base.help.description");
		}
		...
		public boolean onCommand(CommandSender sender, String label, String[] args) {
			...
			Core.getMessages().senderSendMessage(sender, ChatColor.GOLD + mRootCommandDescription);
			Core.getMessages().senderSendMessage(sender,
					ChatColor.GOLD + Core.getMessages().getString("core.commands.base.help.commands"));
